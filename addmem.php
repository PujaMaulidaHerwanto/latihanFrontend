    ...
    <table align="center" border="2" class="display mt-4 table table-striped table-hover table-bordered" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="?menu=addmem&hapus&id=<?php echo $r['id'] ?>" onclick="return confirm('Hapus Data?')">HAPUS</a></td>
                <td><a href="?menu=addmem&edit&id=<?php echo $r['id'] ?>">EDIT</a></td>
            </tr>
            <?php } } ?>
        </tbody>
    </table>
